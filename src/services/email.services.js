...
export const sendVerificationEmail = async (email, otp) => {
  try {
    const mailOptions = {
      from: `"Social Blog" <no-reply@socialblog.com>`,
      to: email,
...
export const sendWelcomeEmail = async (email, username) => {
  try {
    const mailOptions = {
      from: `"Social Blog" <no-reply@socialblog.com>`,
      to: email,
      subject: "Welcome to Social Blog!",
      text: `Hi ${username}, welcome to Social Blog. Start sharing your ideas and connecting with others today.`,
      html: `
